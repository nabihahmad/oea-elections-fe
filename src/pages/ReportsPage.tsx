...
import { Smartphone, Users, Vote, UserCheck, UserRoundCheck, HeartHandshake } from "lucide-react";
...
const ReportsPage = () => {
  ...
  const [stats, setStats] = useState<Stats[]>([
    { label: "Total Engineers", key: "totalRegisteredEngineers", value: "—", icon: Users, color: "text-accent" },
    { label: "Total Eligible Engineers", key: "totalEligibleEngineers", value: "—", icon: UserRoundCheck, color: "text-accent" },
